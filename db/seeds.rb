...
[
  ...
  { pt: 'Ciência e Tecnologia', en: 'Science & Technology', fr: 'Sciences et technologie' },
  ...
  { pt: 'Literatura', en: 'Literature', fr: 'Litérature' },
  { pt: 'Mobilidade e Transporte', en: 'Mobility & Transportation', fr: 'Mobilité et transport' },
  { pt: 'Meio Ambiente', en: 'Environment', fr: 'Environnement' },
  { pt: 'Negócios Sociais', en: 'Social Business', fr: 'Social' },
  { pt: 'Educação', en: 'Education', fr: 'Education' },
  { pt: 'Filmes de Ficção', en: 'Fiction Films', fr: 'Film Fiction' },
  { pt: 'Filmes Documentários', en: 'Documentary Films', fr: 'Film documentaire' },
  { pt: 'Filmes Universitários', en: 'Experimental Films', fr: 'Film Universitaire' }
].each do |name|
   category = Category.find_or_initialize_by(name_pt: name[:pt])
   category.update_attributes({name_fr: name[:fr]})
   category.update_attributes({name_en: name[:en]})
 end

{
  company_name: 'BitBankIn',
