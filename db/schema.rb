...
ActiveRecord::Schema.define(version: 20141127215219) do
  ...
  create_table "contributions", force: true do |t|
    ...
    t.datetime "requested_refund_at"
    t.datetime "refunded_and_canceled_at"
    t.datetime "deleted_at"
    t.datetime "invalid_payment_at"
    t.text     "acquirer_name"
    t.text     "acquirer_tid"
